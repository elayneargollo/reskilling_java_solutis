...
public final class Questoes {
	...
	public static void Questao11() {
		numbers.stream().distinct().sorted(Integer::compareTo).forEach(num -> {
			System.out.println(LocalDate.now().plusDays(num).format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
		});
	}
}
